...
def get_kernel510_version(version):
    rule = r'-((\d+\.)*\d+)'
...
def kernel510_version_compare(version1, version2_parts):
    version1_parts = get_kernel510_version(version1)
    if version1_parts:
